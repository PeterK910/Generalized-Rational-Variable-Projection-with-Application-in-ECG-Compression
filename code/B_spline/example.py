...
init_knot = np.arange(1, M + 1, 2)  # initial knots (following matlab fashion)

s, knots, coeff, prd = compress(signal[0], order, prd_limit, init_knot, show)
# Note: returned knots are the exact same as they would be in matlab,
#       hence the adjustment by -1, to be correct for python indexing.
knots = knots - 1
